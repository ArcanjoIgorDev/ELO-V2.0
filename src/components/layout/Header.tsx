    ...
    <header className="flex-none z-40 w-full pt-safe bg-midnight-950/80 backdrop-blur-md border-b border-white/5">
      <div className="h-16 w-full flex items-center justify-between px-5 max-w-lg mx-auto">
        ...
        <button 
          ...
          className="flex items-center space-x-2 group cursor-pointer active:scale-95 transition-transform absolute left-1/2 -translate-x-1/2"
        >
          <div className="bg-ocean text-white p-1.5 rounded-xl shadow-[0_0_15px_rgba(14,165,233,0.3)]">
            <Waves size={18} strokeWidth={3} />
          </div>
          <span className="text-lg font-bold tracking-tight text-white font-sans hidden sm:block">ELO</span>
        </button>
