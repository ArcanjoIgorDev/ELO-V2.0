    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-midnight-950/80 backdrop-blur-md p-6 animate-fade-in">
      <div className="w-full max-w-sm bg-midnight-900 border border-white/10 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex flex-col items-center text-center mt-4">
          <div className="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center text-primary mb-6 ring-1 ring-primary/20 shadow-[0_0_30px_rgba(14,165,233,0.15)] animate-float">
          ...
          <button 
            ...
            className="w-full bg-primary hover:bg-sky-500 text-white font-bold py-3.5 rounded-xl transition-all shadow-lg shadow-primary/20 active:scale-95 flex items-center justify-center gap-2"
          >
